...
try {
    ...
    $doctors = $database->prepare("SELECT * FROM doctors LEFT JOIN departments ON doctors.depart_id = departments.id");
    $doctors->execute();
        ...
        <div class="sidebar relative p-10">
            ...
            <ul class="links flex">
                ...
                <li class="num m-b-15 action">
                    ...
                    <div class="list">
                        <a href="doctors.php" class="m-r-10 width100 active">الأطباء</a>
        ...
        <div class="content width100">
            <div class="header flex-sb-c p-10 m-b-20">
                ...
                if (isset($_POST['medicine_name'])) {
                    ...
                    $med = $database->prepare("SELECT * FROM doctors LEFT JOIN departments ON doctors.depart_id = departments.id WHERE doc_name LIKE :name");
            ...
            <div class="doctors-list width100">
                <div class="head flex-sb-c width100 p-rl-10">
                    <h2 class="bold ">قائمة الأطباء</h2>
                ...
                <div class="doctor_table p-rl-10">
...
if (isset($_POST['medicine_name'])) {
    if ($med->rowCount() >= 1) {
        foreach($med as $med){
            ...
            <td>' . $med['d_name'] . '</td>
            <td>' . $med['email'] . '</td>
            <td class="modefie flex-ev-c" style="display: flex; align-items:center;">
                <a href="edit_doctor.php?id=' . $med['doc_id'] . '"  style="width: 35px;background-color:#2745e652;font-size:14px"><i class="fa-solid fa-pen"></i></a>
                <form method="get" action="delete.php">
                    <button type="submit" name="doctor_id" value="' . $med['doc_id'] . '"  style="width: 35px;background-color:#ff000035;font-size:14px"><i class="fa-solid fa-xmark"></i></button>
                </form>
            </td>
            <td>
            ...
            <td colspan=5 style="font-size: 20px;font-weight:600">لا يوجد طبيب بهذا الاسم</td>
                            ...
                            foreach ($doctors as $doctor) {
                                echo '<tr>
                                        ...
                                        <td>' . $doctor['email'] . '</td>
                                        <td class="modefie flex-ev-c" style="display: flex; align-items:center;">
                                            <a href="edit_doctor.php?id=' . $doctor['doc_id'] . '"  style="width: 35px;background-color:#2745e652;font-size:14px"><i class="fa-solid fa-pen"></i></a>
                                            <form method="get" action="delete.php">
                                                <button type="submit" name="doctor_id" value="' . $doctor['doc_id'] . '"  style="width: 35px;background-color:#ff000035;font-size:14px"><i class="fa-solid fa-xmark"></i></button>
                                            </form>
                                        </td>
                                        <td>
                                            <a href="doctor_details.php?id=' . $doctor['doc_id'] . '"><i class="fa-solid fa-ellipsis"></i></a>
                                        </td>
                                    </tr>';
                            }
                        }
