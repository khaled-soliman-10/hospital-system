...
<body>
    <div class="page flex">
        ...
        <div class="content width100 relative">
            ...
            <div class="salaries p-20">
                <div class="salaries_header flex-sb-c m-b-20">
                    <h2>قائمة رواتب الأطباء</h2>
                    <img class="" style="width: 120px;" src="images/download__15_-removebg-preview.png" alt="">
                </div>
                <div class="salaries_table">
                            ...
                            if (isset($_POST['medicine_name'])) {
                                if ($med->rowCount() >= 1) {
                                    foreach($med as $med){
                                        ...
                                        <td>' . $med['doc_name'] . '</td>
                                        <td>' . $med['d_name'] . '</td>
                                        <td>' . $med['hours_work'] . ' ساعات</td>
                                        <td>' . $med['join_date'] . '</td>
                                        <td>' . $med['salary'] . ' جنية </td>
                                    </tr>';
                                    }
                                }else{
                                echo '<tr>
