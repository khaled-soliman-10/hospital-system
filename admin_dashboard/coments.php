...
try {
    ...
    $comments = $database->prepare("SELECT * FROM comments");
    $comments->execute();
...
<body>
    <div class="page flex">
        ...
        <div class="content width100">
            ...
            <div class="coments width100 grid p-15">
                <?php
                
                foreach ($comments as $comment) {
                    echo '<div class="">
                            <p class="from relative" style="color: #322eb0">
                                مرسل من/ <span>' . $comment['name'] . '</span>
                            </p>
                            <p>' . $comment['message'] . '</p>
                        </div>';
                }
