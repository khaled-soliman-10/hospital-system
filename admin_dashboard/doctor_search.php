    ...
    <div class="page flex">
        <div class="sidebar relative p-10">
            ...
            <form method="post" class="log-out absolute">
                <button type="submit" name="logout" class="width100">
        ...
        <div class="content width100 relative">
            ...
            <div class="patient_search p-20 m-20">
                ...
                <form action="" class="m-t-20 m-b-20" method="post">
                    <label for="s_p" class="bold m-r-10">البحث عن طبيب</label>
                    <input type="search" name="searchForPatient" id="s_p" placeholder="إسم الطبيب">
                    <button type="submit" class="b-s m-t-20">بحث</button>
                </form>
                <div class="patient_table doc_table">
                    <table class="width100">
                        ...
                        <tbody>
                            <tr>
                                <td>احمد صلاح</td>
                                <td>نيو دلهي الهند</td>
                                <td>01002030402</td>
                                <td>امراض كلى</td>
                                <td>as17@gmail.com</td>
                                <td class="modefie ">
                                    <form action="" method="post" class="flex-c-c">
                                        <a href="edit_doctor.php"><i class="fa-solid fa-pen"></i></a>
