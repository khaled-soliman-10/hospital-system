...
try {
    ...
    if (isset($_GET['name'])) {
        $pHistory = $database->prepare("SELECT * FROM med_history WHERE p_name = :name");
        $pHistory->bindParam("name",$_GET['name']);
        $pHistory->execute();
    }
...
<body>
    ...
    <section class="main start">
        <div class="sidebar relative p-10" style="height: 100%;">
        ...
        <div class="content clm">
            ...
            <div class="medical-history clm">
                ...
                <div class="header width100 flex-sb-c ">
                    <h1 class="flex-0-c">
                        <a href="patients.php" class="center m-l-20"><i class="fa-solid fa-xmark"></i></a>
