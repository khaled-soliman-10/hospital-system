    ...
    <section class="main start">
        ...
        <div class="content clm">
            <header class="center">
                ...
                <form action="" method="get" class="center">
                    <div class="center">
                        ...
                        <input type="search" name="name" class="search" placeholder="البحث عن التحليل">
                    </div>
            ...
            <div class="patient_search">
                <h2 class="">عرض التحليل</h2>
                <form action="" class="" method="post">
                    <label for="s_p">البحث عن التحليل</label>
                    <input type="search" name="searchForPatient" id="s_p" placeholder="إسم التحليل">
